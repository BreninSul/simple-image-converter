...
/**
 * The `FillSettings` class represents the settings for performing a fill operation on an image.
 * It inherits from the `TransformSettings` interface and provides methods to retrieve the painter for the fill operation.
 *
 * @property colour The primary color to be used for the fill operation. It is an optional value.
 * @property colourPainter The painter for the fill operation that uses a solid color. It is an optional value.
 * @property randomPainter The painter for the fill operation that uses a random color. It is an optional value.
 * @property linearGradient The linear gradient for the fill operation. It is an optional value.
 * @property radialGradient The radial gradient for the fill operation. It is an optional value.
 *
