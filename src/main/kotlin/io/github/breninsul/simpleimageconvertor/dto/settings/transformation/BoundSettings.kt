...
/**
 * The `BoundSettings` class represents a set of settings for performing bound transformation on an image.
 * It extends the `TransformSettings` interface.
 *
 * @property resolution The resolution of the transformed image.
 * @property method The scale method to be used for the bound transformation. It has a default value of `ScaleMethod.Bicubic`.
 *
 * @constructor Creates a `BoundSettings` instance with the specified resolution and scale method.
 *
