...
/**
 * The `AlphaCompositeSettings` class represents the settings for applying an alpha composite operation on images.
 *
 * @property alpha The level of transparency to be applied. Valid range is from 0.0 to 1.0, where 0.0 is fully transparent and 1.0 is fully opaque.
