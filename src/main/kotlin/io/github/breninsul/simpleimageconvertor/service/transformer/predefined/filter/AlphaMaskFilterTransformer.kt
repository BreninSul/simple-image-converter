...
/**
 * The `AlphaMaskFilterTransformer` class is an implementation of the `OperationWitSecondImageTransformer` class.
 * It represents a transformer that performs the alpha mask filter operation on an image using a second image as the mask.
 *
 * @param T The type of the operation settings. It must extend the `AlphaMaskFilterSettings` class.
