...
/**
 * Represents a class for writing ICNS images using the TwelveMonkeys library.
 *
 * @param order The order of the ICNS writer. The default value is 1.
 *
 * @constructor Creates an instance of the IcnsWriter class with the given order.
 *
