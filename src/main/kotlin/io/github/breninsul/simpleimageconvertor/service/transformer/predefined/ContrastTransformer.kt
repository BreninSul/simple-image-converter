...
/**
 * The `ContrastTransformer` class is a subclass of `PredefinedTransformer` that represents a transformer for applying contrast adjustments to images.
 * It provides an implementation for processing image transformations using the provided contrast settings.
 *
