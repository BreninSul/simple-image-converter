...
/**
 * The `ResizeToTransformer` class is a concrete implementation of the `PredefinedTransformer` class.
 * It represents a transformer that resizes an image to a specified resolution using the provided settings.
 *
