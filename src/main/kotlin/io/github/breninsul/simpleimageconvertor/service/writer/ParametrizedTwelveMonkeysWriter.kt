...
/**
 * Represents a class for writing images using the TwelveMonkeys library with customizable parameters.
 *
 * @param format The format of the image to be written.
 *
 * @constructor Creates a new instance of the ParametrizedTwelveMonkeysWriter class with the given format.
 *
 * @see ImageWriter
 * @see ImageWriteParam
 * @see BufferedImage
